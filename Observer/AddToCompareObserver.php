...
class AddToCompareObserver extends ImpreseeRegisterStoreEventObserver
{
    ...
    {
        parent::__construct($logger, $codes, $httpHeader, $remoteAddress, $customerSession, 'ADD_TO_COMPARE');
    }
